...
import serverConfiguration from '../server/main/configuration.jsx';
...
(
	...
	// ({
	// 	context  : serverConfiguration.context,
...
configuration.entry.main =
	[
		...
		`webpack-hot-middleware/client?path=http://${serverConfiguration.development.webpack.development_server.host}:${serverConfiguration.development.webpack.development_server.port}/__webpack_hmr`,
		configuration.entry.main
	]

// network path for static files: fetch all statics from webpack development server
configuration.output.publicPath = `http://${serverConfiguration.development.webpack.development_server.host}:${serverConfiguration.development.webpack.development_server.port}${serverConfiguration.output.publicPath}`
...
development_server.listen(serverConfiguration.development.webpack.development_server.port, (error) =>
{
	if (error)
	{
